...
import { formAction } from "../locale-path";
...
export function SearchDesk({
  ...
  return (
    <div className="paper-card">
      ...
      <div className="p-5">
        {tab === "hotels" ? (
          <form action={formAction(locale, "/hotels")} method="get" className="grid gap-3">
        ...
        {tab === "tickets" ? (
          <form action={formAction(locale, "/tickets")} method="get" className="grid gap-3">
            <div className="grid grid-cols-2 gap-3">
              <label className="grid gap-1 text-xs text-ink-soft">
                {t("from")}
        ...
        {tab === "routes" ? (
          <form action={formAction(locale, "/routes")} method="get" className="grid gap-3">
            <label className="grid gap-1 text-xs text-ink-soft">
              {t("nights")}
